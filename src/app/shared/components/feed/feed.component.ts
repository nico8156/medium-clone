...
import { ErroMessageComponent } from "../errorMessage/errorMessage.component";
...
@Component({
    ...
    standalone: true,
    imports:[CommonModule, RouterLink, ErroMessageComponent, LoadingComponent, PaginationComponent, TagListComponent, AddToFavoritesComponent]
})
...
export class FeedComponent implements OnInit, OnChanges{
    ...
    fetchFeed():void{
        ...
        const apiWithParams = `${parsedUrl.url}?${stringifiedUrl}`
