...
import { ErroMessageComponent } from "../shared/components/errorMessage/errorMessage.component";
...
@Component({
    ...
    standalone:true,
    imports:[CommonModule, RouterLink, LoadingComponent, ErroMessageComponent, TagListComponent]
})
